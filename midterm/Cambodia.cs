...
namespace OOP2
{
    public partial class Cambodia : Form
    {
        ...
        int currentIndex = 1;
        public Cambodia(int userID)
        {
            InitializeComponent();
            this.userID = userID;
            InitializeDatabase();
            LoadPanelInfoFromDatabase("Cambodia");
        ...
        private void addBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                if (SavePanelInfoToDatabase(openFileDialog.FileName, buttonName, status, "Cambodia"))
                {
                    CreatePanel(openFileDialog.FileName, buttonName, status, "Cambodia");
                }
            }
        }
