...
namespace OOP2
{
    public partial class Thailand : Form
    {
        ...
        public Thailand(int userID)
        {
            InitializeComponent();
            this.userID = userID;
            InitializeDatabase();
            LoadPanelInfoFromDatabase("Thailand");
        ...
        private void addBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                if (SavePanelInfoToDatabase(openFileDialog.FileName, buttonName, status, "Thailand"))
                {
                    CreatePanel(openFileDialog.FileName, buttonName, status, "Thailand");
                }
            }
        }
