...
namespace OOP2
{
    public partial class Indonesia : Form
    {
        ...
        int currentIndex = 1;
        public Indonesia(int userID)
        {
            InitializeComponent();
            this.userID = userID;
            InitializeDatabase();
            LoadPanelInfoFromDatabase("Indonesia");
        ...
        private void addBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                if (SavePanelInfoToDatabase(openFileDialog.FileName, buttonName, status, "Indonesia"))
                {
                    CreatePanel(openFileDialog.FileName, buttonName, status, "Indonesia");
                }
            }
        }
