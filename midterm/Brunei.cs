...
namespace OOP2
{
    public partial class Brunei : Form
    {
        ...
        public Brunei(int userID)
        {
            InitializeComponent();
            this.userID = userID;
            InitializeDatabase();
            LoadPanelInfoFromDatabase("Brunei");
        ...
        private void addBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                if (SavePanelInfoToDatabase(openFileDialog.FileName, buttonName, status, "Brunei"))
                {
                    CreatePanel(openFileDialog.FileName, buttonName, status, "Brunei");
                }
            }
        }
        private void addBtn2_Click_1(object sender, EventArgs e)
        {
        ...
        private void LoadImagesFromDatabase(string attractionName)
        {
            ...
            if (attractionImages.Count > 0)
            {
                ...
                innerPictureBox.SizeMode = PictureBoxSizeMode.Zoom; // Adjust PictureBox properties
