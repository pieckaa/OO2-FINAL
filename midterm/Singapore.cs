...
namespace OOP2
{
    public partial class Singapore : Form
    {
        ...
        public Singapore(int userID)
        {
            InitializeComponent();
            this.userID = userID;
            InitializeDatabase();
            LoadPanelInfoFromDatabase("Singapore");
        ...
        private void addBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                if (SavePanelInfoToDatabase(openFileDialog.FileName, buttonName, status, "Singapore"))
                {
                    CreatePanel(openFileDialog.FileName, buttonName, status, "Singapore");
                }
            }
        }
