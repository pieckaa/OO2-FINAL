...
namespace OOP2
{
    public partial class Philippines : Form
    {
        ...
        public Philippines(int userID)
        {
            InitializeComponent();
            this.userID = userID;
            InitializeDatabase();
            LoadPanelInfoFromDatabase("Philippines");
        ...
        private void addBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                if (SavePanelInfoToDatabase(openFileDialog.FileName, buttonName, status, "Philippines"))
                {
                    CreatePanel(openFileDialog.FileName, buttonName, status, "Philippines");
                }
            }
        }
