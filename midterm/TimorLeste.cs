...
namespace OOP2
{
    public partial class TimorLeste : Form
    {
        ...
        public TimorLeste(int userID)
        {
            InitializeComponent();
            this.userID = userID;
            InitializeDatabase();
            LoadPanelInfoFromDatabase("Timor-Leste");
        ...
        private void addBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                if (SavePanelInfoToDatabase(openFileDialog.FileName, buttonName, status, "Timor-Leste"))
                {
                    CreatePanel(openFileDialog.FileName, buttonName, status, "Timor-Leste");
                }
            }
        }
