...
namespace OOP2
{
    public partial class Laos : Form
    {
        ...
        public Laos(int userID)
        {
            InitializeComponent();
            this.userID = userID;
            InitializeDatabase();
            LoadPanelInfoFromDatabase("Laos");
        ...
        private void addBtn_Click_1(object sender, EventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                if (SavePanelInfoToDatabase(openFileDialog.FileName, buttonName, status, "Laos"))
                {
                    CreatePanel(openFileDialog.FileName, buttonName, status, "Laos");
                }
            }
        }
