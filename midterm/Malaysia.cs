...
namespace OOP2
{
    public partial class Malaysia : Form
    {
        ...
        public Malaysia(int userID)
        {
            InitializeComponent();
            this.userID = userID;
            InitializeDatabase();
            LoadPanelInfoFromDatabase("Malaysia");
        ...
        private void addBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                if (SavePanelInfoToDatabase(openFileDialog.FileName, buttonName, status, "Malaysia"))
                {
                    CreatePanel(openFileDialog.FileName, buttonName, status, "Malaysia");
                }
            }
        }
