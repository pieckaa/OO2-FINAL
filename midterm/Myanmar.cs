...
namespace OOP2
{
    public partial class Myanmar : Form
    {
        ...
        public Myanmar(int userID)
        {
            InitializeComponent();
            this.userID = userID;
            InitializeDatabase();
            LoadPanelInfoFromDatabase("Myanmar");
        ...
        private void addBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                if (SavePanelInfoToDatabase(openFileDialog.FileName, buttonName, status, "Myanmar"))
                {
                    CreatePanel(openFileDialog.FileName, buttonName, status, "Myanmar");
                }
            }
        }
